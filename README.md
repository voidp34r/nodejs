...
Pointing `oc new-app` at source code kicks off a chain of events, for our example run:
        ...
        $ oc new-app https://github.com/voidp34r/nodejs -l name=myapp
...
We can also [create new apps using OpenShift template files](https://docs.openshift.com/enterprise/3.0/dev_guide/new_app.html#specifying-a-template). Clone the demo app source code from [GitHub repo](https://github.com/voidp34r/nodejs) (fork if you like).

        $ git clone https://github.com/voidp34r/nodejs
...
Which should return something like:
        ...
        svc/nodejs - 172.30.108.183:8080
          dc/nodejs deploys istag/nodejs:latest <-
            bc/nodejs builds https://github.com/voidp34r/nodejs with openshift/nodejs:0.10
...
You can alternatively leave off `--follow` and use `oc logs build/nodejs-n` where *n* is the number of the build to track the output of the build.
...
This will help indicate what IP address the service is running, the default port for it to deploy at is 8080. Output should look like:
        ...
        nodejs   172.30.249.251   <none>        8080/TCP   deploymentconfig=nodejs,name=myapp   17m
...
This could also be accomplished by running:
        ...
        $ oc expose svc/nodejs --hostname=www.example.com
...
Running `oc status` or checking the web console will reveal the address of the newly created MongoDB:
	...
	http://10.2.2.2 to pod port 8080-tcp (svc/nodejs)
	  dc/nodejs deploys istag/nodejs:latest <-
	    bc/nodejs builds https://github.com/voidp34r/nodejs with openshift/nodejs:0.10
...
We need to add the environment variable `MONGO_URL` to our Node.js web app so that it will utilize our MongoDB, and enable the "Page view count" feature. Run:
        ...
        $ oc set env dc/nodejs MONGO_URL='mongodb://admin:secret@172.30.0.112:27017/mongo_db'
